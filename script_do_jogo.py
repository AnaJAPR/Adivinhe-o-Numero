...
sleep(1)
print("0.Não \n1.Sim")
escolha_de_jogar = input("Sua resposta: ")
...
try:
    if escolha_de_jogar == 0:
        ...
        while quant_chutes < 10:
            ...
            if num_chutado > num_sorteado:
                ...
                break
    elif type(escolha_de_jogar) != int:
        raise TypeError
    ...
    print("Tipo inválido, sua resposta deve ser um número inteiro!")
except ValueError:
    print("Resposta inválida, digite 0 ou 1 por favor!")   